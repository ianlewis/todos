...
// Command genlangdocs generates the supported languages documentation based on
...
func main() {
	...
	fmt.Println("<!-- NOTE: Generated by github.com/ianlewis/todos/internal/cmd/genlangdocs DO NOT EDIT. -->")
	fmt.Println("")
